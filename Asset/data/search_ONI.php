...
<html>
    <head>
        <title>Pencarian Data ONI</title>
    </head>
    <body>
        <div style="border:1px solid #B0C4DE; padding:10px; overflow:auto;">
        <form action="search_ONI.php" method="post" name="postform">
            <p align="center"><font color="orange" size="3"><b>Pencarian Data ONI</b></font></p><br />
            <table align="center" border="0">
                <tr>
                    ...
                    <td colspan="2" width="70"><input type="reset" value="Back" onclick="document.location='ONI.php'"/></td>
                </tr>
            </table>
        </form><br />
      </div>
        <?php
            ...
            <script language="JavaScript">
                ...
                document.location='search_ONI.php';
            </script>
            ...
            <?php
            $query=mysqli_query($db_link,"select * from oni WHERE TAHUN between '$tahun_awal' and '$tahun_akhir'");
            }
        ?>
