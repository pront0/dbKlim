...
<html>
    <head>
        <title>Pencarian Data IOD</title>
    </head>
    <body>
        <div style="border:1px solid #B0C4DE; padding:10px; overflow:auto;">
        <form action="search_IOD.php" method="post" name="postform">
            <p align="center"><font color="orange" size="3"><b>Pencarian Data IOD</b></font></p><br />
            <table align="center" border="0">
                <tr>
                    ...
                    <td colspan="2" width="70"><input type="reset" value="Back" onclick="document.location='IOD.php'"/></td>
                </tr>
            </table>
        </form><br />
      </div>
        <?php
            ...
            <script language="JavaScript">
                ...
                document.location='search_IOD.php';
            </script>
            ...
            <?php
            $query=mysqli_query($db_link,"select * from iod WHERE TAHUN between '$tahun_awal' and '$tahun_akhir'");
            }
        ?>
