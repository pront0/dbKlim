...
<table border="1">
 ...
 <tr>
  ...
  $data = mysqli_query($db_link, "select * from dmi");
  ...
  <tr>
    ...
    <td p align="center">
	<a href="edit_DMI.php?ni=<?php echo $d['TAHUN'];?>" title="Edit data ini"> EDIT ||</a>
	<a href="delete_DMI.php?ni=<?php echo $d['TAHUN'];?>" onclick="return confirm ('Apakah anda yakin ingin menghapus data ini ?');"> HAPUS </a>
    </td>
  </tr>
