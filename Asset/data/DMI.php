...
<html lang="en" dir="ltr">
  ...
  <div id="main">
    <h3 align="center">Data DMI</h3>
    <div align="center">
    <a href="export_DMI.php"><button>Export to Excel</button></a>
    <a href="add_DMI.php"><button>Add Data</button></a>
    <a href="search_DMI.php"><button>Cari Data</button></a><br/>
    </div>
    <hr/>
  </div>

  <?php
    include 'data_DMI.php';
  ?>
