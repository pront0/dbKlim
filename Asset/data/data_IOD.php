...
<table border="1">
 ...
 <tr>
  ...
  $data = mysqli_query($db_link, "select * from iod");
  ...
  <tr>
    ...
    <td p align="center">
	<a href="edit_IOD.php?ni=<?php echo $d['TAHUN'];?>" title="Edit data ini"> EDIT ||</a>
	<a href="delete_IOD.php?ni=<?php echo $d['TAHUN'];?>" onclick="return confirm ('Apakah anda yakin ingin menghapus data ini ?');">HAPUS</a>
    </td>
  </tr>
