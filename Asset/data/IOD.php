...
<html lang="en" dir="ltr">
  ...
  <div id="main">
    <h3 align="center">Data IOD</h3>
    <div align="center">
    <a href="export_IOD.php"><button>Export to Excel</button></a>
    <a href="add_IOD.php"><button>Add Data</button></a>
    <a href="search_IOD.php"><button>Cari Data</button></a><br/>
  </div>
    <hr/>
  </div>

  <?php
    include 'data_IOD.php';
  ?>
