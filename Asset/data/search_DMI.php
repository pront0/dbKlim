...
<html>
    <head>
        <title>Pencarian Data DMI</title>
    </head>
    <body>
        <div style="border:1px solid #B0C4DE; padding:10px; overflow:auto;">
        <form action="search_DMI.php" method="post" name="postform">
            <p align="center"><font color="orange" size="3"><b>Pencarian Data DMI</b></font></p><br />
            <table align="center" border="0">
                <tr>
                    ...
                    <td colspan="2" width="70"><input type="reset" value="Back" onclick="document.location='DMI.php'"/></td>
                </tr>
            </table>
        </form><br />
      </div>
        <?php
            ...
            <script language="JavaScript">
                ...
                document.location='search_DMI.php';
            </script>
            ...
            <?php
            $query=mysqli_query($db_link,"select * from dmi WHERE TAHUN between '$tahun_awal' and '$tahun_akhir'");
            }
        ?>
