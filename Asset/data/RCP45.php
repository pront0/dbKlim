...
<html lang="en" dir="ltr">
  ...
  <div id="main">
    <h3 align="center">Data RCP4.5</h3>
    <div align="center">
    <a href="export_RCP45.php"><button>Export to Excel</button></a>
    <a href="add_RCP45.php"><button>Add Data</button></a>
    <a href="search_RCP45.php"><button>Cari Data</button></a><br/>
  </div>
    <hr/>
  </div>

  <?php
    include 'data_RCP45.php';
  ?>
