...
<html>
    <head>
        <title>Pencarian Data RCP4.5</title>
    </head>
    <body>
        <div style="border:1px solid #B0C4DE; padding:10px; overflow:auto;">
        <form action="search_RCP45.php" method="post" name="postform">
            <p align="center"><font color="orange" size="3"><b>Pencarian Data RCP4.5</b></font></p><br />
            <table align="center" border="0">
                <tr>
                    ...
                    <td colspan="2" width="70"><input type="reset" value="Back" onclick="document.location='RCP45.php'"/></td>
                </tr>
            </table>
        </form><br />
      </div>
        <?php
            ...
            <script language="JavaScript">
                ...
                document.location='search_RCP45.php';
            </script>
